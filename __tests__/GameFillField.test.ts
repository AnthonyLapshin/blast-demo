...
jest.mock('../assets/Scripts/Libs/utils/ArrayUtils');
jest.mock('../assets/Scripts/Services/FieldCoordinatesService');
...
import { GameFillField } from '../assets/Scripts/Game/GameSM/States/GameFillField';
...
import { ArrayUtils } from '../assets/Scripts/Libs/utils/ArrayUtils';
import { Node } from 'cc';
